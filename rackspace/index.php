    ...
    <div id="content">
      <div>
        ...
        <div id="content-body">
          ...
          <div id="divider"></div>
          <form id="form" method="post"  action="login_parse.php" autocomplete="off">
  <div id="form-body">
      ...
      <div id="user-row" class="row">
        <div id="user-col" class="col">
          <div id="user-field" class="form-group">
            ...
            <input id="user-input" type="email" name="user" tabindex="1" class="form-field" value="<?php echo $attmail; ?>" autocomplete="username">
          </div>
        </div>
      </div>
